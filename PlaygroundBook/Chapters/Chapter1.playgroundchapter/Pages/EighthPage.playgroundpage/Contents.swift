/*:
 ...
 To help people like Sonny we should think from the beginning of the project how we name our elements, so when adapting to voiceOver won't be an exhausting task.
