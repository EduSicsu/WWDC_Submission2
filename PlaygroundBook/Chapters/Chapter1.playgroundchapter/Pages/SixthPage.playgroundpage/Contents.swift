...
Our mission now is to help them differentiate colors, a good tip is inserting patterns so that the information for them is clear.
 
 Your job here, is to replace the element colorNormal by elements with patterns:
